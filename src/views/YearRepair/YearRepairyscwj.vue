          ...
          <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="计划单" name="first">
              ...
              <div style="display: flex;justify-content: space-around;">
                ...
                <p>会议纪要:<img src="https://axure-file.lanhuhu.com/21a8b113-c334-4252-80ac-7514e60de361__205d41261be2727693b042a6dcd9165e.svg" style="height: 35px;vertical-align: middle;"><el-button type="text" @click="conference=true">预览</el-button>
                </p>
              </div>
            </el-tab-pane>
