    ...
    <div>
                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        ...
                        <el-tab-pane label="计划单" name="first">
                            ...
                            <div class="ztable">
                                ...
                                <div class="jhbg">
                                    <!-- <p>计划内变更</p> -->
                                    <ul style="padding: 0 0 0 25px;line-height: 40px;">
                                        <li>
                                            计划类别:<span>{{zjlb}}</span>
                                        </li>
                                    ...
                                    <el-table
                                        ...
                                        <el-table-column label="操作" width="200" align='center'>
                                            <template slot-scope="scope">
                                                ...
                                                <el-button type="text" size="small" @click="check(scope.row)">查看商品</el-button>
        ...
        <div style="border-top: 23px solid #d4d6d5;margin-top: 12%;">
            <div style="display: flex;height: 60px;align-items: center;padding-left: 5%;margin-top: 20px;">
                <span style="display: inline-block;margin-right: 20px;">批复文件</span>
                <el-upload
                    class="upload-demo"
