			...
			<el-card class="box-card" shadow="never" style="margin-top:20px;">
				...
				<div class="text item">
					<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
						<el-form-item label="是否需要负责人审核" prop="needTechnologyExamine">
							<el-select v-model="ruleForm.needTechnologyExamine" style="width:400px;" placeholder="是否需要负责人审核">
				...
				this.$refs[formName].validate((valid) => {
					if(valid) {
						var param = {
							...
							"needCompanyExamine": "",
							"needTechnologyExamine": this.ruleForm.needTechnologyExamine,
