<template>
	<div style="padding:20px;">
		...
		<el-dialog title="流程图" :visible.sync="showModal" width=80%>
			<img src="../../../static/img/ndkyxmbb.png">
		</el-dialog>
		<!-- 在线编辑 -->
	...
	export default {
		...
		methods: {
                ...
                if(!submitBool) {
                    ...
                    this.$refs['ruleForm'].validate((valid) => {
                        ...
                        var param = {
                            ...
                            businessForm: "/supplement/supplementT",
                            departId: this.departId,
                            deploymentKey: "ndkjzjbblc",
                            id: this.ruleForm.userId,
                            name: this.name,
                            processName: "年度科技资金补报流程",
                            userId: sessionStorage.userId
                            },
                            submitType: m
                        }
                        postAjaxx("/api/planmanagementService/technologyPlanReport/saveTechnologyPlanReport", JSON.stringify(param)).then(res => {
                            if(res.code == 0) {
                            this.$message("成功");
                            this.$router.push({
                                path: '/home/index',
            ...
            created() {
                ...
                postAjaxJson(`/api/process-service/userTask/getFirstExaminePerson/ndkjzjbblc`, param).then(res => {
                    if(res.code == 0) {
