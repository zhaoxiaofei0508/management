			...
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
				<div class="content_top">
					<el-form-item label="标题" prop="title">
						<el-input v-model="ruleForm.title" placeholder="月度生产物资计划"></el-input>
					</el-form-item>
        ...
        this.$refs['ruleForm'].validate((valid) => {
          ...
          if (valid) {
            ...
            param = {
                ...
                if(bo){
                  postAjaxx("/api/planmanagementService/planMonthly/planMonthlyStartFlow", JSON.stringify(param)).then(res => {
                      if (res.code == 0) {
                          this.$message("添加成功");
                          this.$router.push({
                              path:"/home/index"
