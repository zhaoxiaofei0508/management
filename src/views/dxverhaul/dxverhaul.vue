    ...
    <div>
        ...
        <div class="content">
            <div class="content_top">
                <p>标题:<input type="text" v-model="zzzzzz" placeholder="年度大修资金计划"></p>
            ...
            <div class="essential_top">
                ...
                <div class="category">
                    *项目类别 
                    <el-select  v-model="searchValue"  placeholder="请选择" class="input" @change="chickvalue">
                        <el-option
                ...
                <div class="information" v-for="(item, index1) in ruleForm.domain" :key='index1'>
                    <p>项目:{{stats}}<span @click="addRule" v-if="add">添加项目</span><i @click.prevent="removes(item)" id="rome" v-if="remove">删除项目</i></p>
                    <ul>
                        <li>
                        <el-form-item 
                        label="项目名称" 
                    ...
                    <div class="table">
                        ...
                        <el-table
                                ...
                                align='center'>
                                <template slot-scope="scope">
                                    <el-button @click="accessoryaddRow()" type="text" size="small">增加</el-button>
        ...
        <!-- 添加商品遮罩内容 -->
        <div class="Merchandise" v-if="Merchandise">
            ...
            <div class="ztable">
                <el-table 
                    ...
                    <template slot-scope="scope">
                        <el-input v-model="encoding" class='inputss'></el-input>
                    </template>
                    </el-table-column>
...
var isPrice = (rule, value, callback) => {
    ...
    methods: {
       ...
       chickvalue () {
        ...
        //添加物资保存
        save(){
            console.log('添加物资'+ this.encoding)
        }, 
        // 添加商品增加行
        addRow () {
        var list = {
