			...
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
				<div class="content_top">
					<el-form-item label="标题" prop="title">
						<el-input v-model="ruleForm.title" placeholder="咨询及其他服务计划"></el-input>
					</el-form-item>
...
<script>
	...
	export default {
					...
					this.$refs['ruleForm'].validate((valid) => {
							if(valid) {
								...
								_.forEach(this.ProjetAeeay, value => {
									...
									_.forEach(value.domain, val => {
										...
										planBudgetProjectVoList.push({
											...
											planImplementGoodsList: planBudgetGoodsList,
								...
								var param = {
									...
									"planImplementprojectVoList": planBudgetProjectVoList,
									"startWorkflowParameterVo": {
										...
										name: this.name,
										processName: "咨询及其他服务计划",
										userId: sessionStorage.userId
									},
									submitType: m
								}
								param.planImplement = planImplement
								console.log(param)
								postAjaxx("/api/planmanagementService/Consultation/consultationStartFlow", JSON.stringify(param)).then(res => {
									if(res.code == 0) {
										this.$message("成功");
										this.$router.push({
											path: '/home/index',
		...
		created() {
			...
			postAjaxJson(`/api/process-service/userTask/getFirstExaminePerson/zxjqtfujhlc`, param).then(res => {
				if(res.code == 0) {
