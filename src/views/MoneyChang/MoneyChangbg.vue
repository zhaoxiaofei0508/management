<template>
  <div>
        ...
        <div class="zxfplan">
            ...
            <div class="ztable" style="margin-top: 8%;">
                <p>变更原因</p>
                <span style="padding: 20px;font-size: 14px;">变更说明:{{bgsm}}</span>
            </div>
        </div>
            <p style="margin-left: 50px">审核结果</p>
        <el-form
        :model="ruleForm"
        :rules="Formrules"
        ref="ruleForm"
...
export default {
    ...
    created() {
      ...
      getAjax(
        `/api/planmanagementService/PlanYearSpecialFundsChange/getTechnologyPlan?applyId=`+this.$route.query.businessKey
      ).then(res => {
        console.log(res);
